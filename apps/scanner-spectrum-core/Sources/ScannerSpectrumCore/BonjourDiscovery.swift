...
public struct BonjourDiscoveryResult: Hashable {
    public let ip: String?
    public let service: BonjourService

    public init(ip: String?, service: BonjourService) {
        self.ip = ip
...
@MainActor
public final class BonjourDiscovery: NSObject, @preconcurrency NetServiceBrowserDelegate, @preconcurrency NetServiceDelegate {
    ...
    private func startBrowsing(timeout: TimeInterval, log: ScannerCoreLogger?) {
    ...
    private func stopBrowsing(log: ScannerCoreLogger?) {
